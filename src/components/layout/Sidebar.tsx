    ...
    <aside className="h-full w-60 bg-white/30 backdrop-blur-xl border-r border-white/50 flex flex-col shrink-0">
          ...
          return (
            <button
              ...
              className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium transition-all cursor-pointer ${
                isActive
                  ? 'bg-forest-500/15 text-forest-700 border border-forest-500/20'
      ...
      <div className="px-3 py-4 border-t border-white/30">
        <div className="flex items-center gap-3 px-4 py-3 rounded-xl hover:bg-white/50 cursor-pointer transition-all">
          <div className="w-8 h-8 bg-forest-500 rounded-full flex items-center justify-center text-white text-xs font-bold flex-shrink-0">
            JD
          </div>
